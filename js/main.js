    ...
    $(document).ready(function () {
       ...
       $("#subscribe-form").on('submit', function (e) {
        ...
        function initialize() {
            ...
            var map;
            var panorama;
            var var_latitude = 59.417736; // Google Map Latitude
            var var_longitude = 17.918668; // Google Map Longitude
            var pin = 'images/icons/pin.svg';

            //Map pin-window details
            var title = "Ett Smart - Click to see";
            var hotel_name = "Ett Smart";
            var hotel_address = "Sollentunavägen - Stockholm";
            var hotel_desc = "Smart och lyxigt hotell";
            var hotel_more_desc = "Ett hotell nära stockholm.";
...
function initMap() {
    ...
    var myLatLng = {lat: 59.42305678, lng: 17.95511466};
